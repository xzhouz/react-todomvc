...
var _stylis = __webpack_require__(32);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(1);var invariant=__webpack_require__(4);var warning=__webpack_require__(6);var ExecutionEnvironment=__webpack_require__(9);var _assign=__webpack_require__(3);var emptyFunction=__webpack_require__(2);var EventListener=__webpack_require__(10);var getActiveElement=__webpack_require__(11);var shallowEqual=__webpack_require__(12);var containsNode=__webpack_require__(13);var focusNode=__webpack_require__(14);var emptyObject=__webpack_require__(5);var checkPropTypes=__webpack_require__(7);var hyphenateStyleName=__webpack_require__(24);var camelizeStyleName=__webpack_require__(26);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function isCheckAll() {
      var todoList = this.state.todoList;
      return todoList.length > 0 && todoList.every(function (item) {
    ...
    value: function checkAll() {
      ...
      var completed = !this.state.checkAll;
      this.setState({
    ...
    value: function render() {
      ...
      var showClear = state.todoList.findIndex(function (item) {
        return item.completed;
      }) > -1 ? true : false;
      return _react2.default.createElement(
        'div',
        { className: 'app' },
        _react2.default.createElement(_header2.default, { submit: this.submit.bind(this),
          checkAll: this.checkAll.bind(this),
          check: this.state.checkAll }),
        _react2.default.createElement(_todoList2.default, { todoList: todoList,
          toggle: this.toggle.bind(this),
          'delete': this.delete.bind(this) }),
        _react2.default.createElement(_footer2.default, { size: this.state.todoList.length,
...
App = (0, _styledComponents2.default)(App)(_templateObject);
...
var _todoInput = __webpack_require__(39);
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_todoInput2.default, { checkAll: this.props.checkAll,
...
TodoInput = (0, _styledComponents2.default)(TodoInput)(_templateObject, function (props) {
  return props.check ? '#777' : '#ddd';
});
  ...
  _createClass(TodoList, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'todolist' },
        this.props.todoList.map(function (value, index) {
          return _react2.default.createElement(_todoItem2.default, { todo: value, key: index, index: index, toggle: _this2.toggle.bind(_this2), 'delete': _this2.delete.bind(_this2) });
        })
      );
    }
  }]);
...
TodoList.propTypes = {
  todoList: _propTypes2.default.array,
...
var Tick = _styledComponents2.default.span(_templateObject, function (props) {
  return props.completed ? 'border: solid 1px #ddd;' : '';
}, function (props) {
  return props.completed ? 'block' : 'none';
});

var Cross = _styledComponents2.default.span(_templateObject2);
  ...
  _createClass(TodoItem, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: className },
        _react2.default.createElement(Tick, { completed: todo.completed, onClick: this.handleToggle.bind(this) }),
        todo.action,
        _react2.default.createElement(Cross, { className: 'cross', onClick: this.handleDelete.bind(this) })
      );
    }
  }]);
...
TodoItem.propTypes = {
  todo: _propTypes2.default.object,
  delete: _propTypes2.default.func,
  toggle: _propTypes2.default.func
};

TodoItem = (0, _styledComponents2.default)(TodoItem)(_templateObject3, function (props) {
  return props.todo.completed ? 'color: #d9d9d9;text-decoration: line-through;' : '';
});
...
var _filterButton = __webpack_require__(43);
...
var Filter = _styledComponents2.default.span(_templateObject);

var ClearButton = _styledComponents2.default.span(_templateObject2);
...
var Footer = function (_React$Component) {
  ...
  _createClass(Footer, [{
    ...
    key: 'filterCompleted',
    value: function filterCompleted() {
      this.props.filter(1);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          _react2.default.createElement(
            _filterButton2.default,
            { handleClick: this.filterAll.bind(this) },
            'All'
          ),
          _react2.default.createElement(
            _filterButton2.default,
            { handleClick: this.filterActive.bind(this) },
            'Active'
          ),
          _react2.default.createElement(
            _filterButton2.default,
            { handleClick: this.filterCompleted.bind(this) },
            'Completed'
          )
        ),
        _react2.default.createElement(
          ClearButton,
          { onClick: clear, className: 'clear', style: style },
          'Clear completed'
        )
      );
    }
...
FilterButton = (0, _styledComponents2.default)(FilterButton)(_templateObject);
